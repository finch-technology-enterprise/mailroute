  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.2 }}>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center px-6 py-20 text-center" style={{ minHeight: 300 }}>
          <div style={{ width: 56, height: 56, borderRadius: 28, background: "var(--border)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 20, color: "var(--text-tertiary)" }}>
          ...
          {!search && (
            <motion.button className="apple-btn apple-btn-primary mt-6" onClick={() => setShowAdd(true)} whileTap={{ scale: 0.97 }}>
              Add Config
            </motion.button>
          )}
        </div>
